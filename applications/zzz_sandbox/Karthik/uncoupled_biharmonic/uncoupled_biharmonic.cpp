...
//
//
// void GetExactSolutionGradient(const std::vector < double >& x, std::vector < double >& gradientValue) {
//     Domains::square_m05p05::Function_Zero_on_boundary_4 <double> analytical_function_1;
//
//     unsigned int m = analytical_function_1.gradient(x).size();
//
//     gradientValue[0] = analytical_function_1.gradient(x)[0];
//     gradientValue[1] = analytical_function_1.gradient(x)[1];
//
// //======ASK-BEGIN===========
//     /*
...
//         gradientvalue[i] = analytical_function_1.gradient(x)[i];
//     }*/
// //     std::cout << "Gradient Value:" << std::endl;
// //     for (size_t i = 0; i < gradientValue.size(); ++i) {
// //         std::cout << "solGrad[" << i << "] = " << gradientValue[i] << std::endl;
// //     }
//
// //======ASK-END===========
// };
...
//     Domains::square_m05p05::Function_Zero_on_boundary_4 <double> analytical_function_1;
//
//     double LaplacianValue = analytical_function_1.laplacian(x);
//
...
//     Domains::square_m05p05::Function_Zero_on_boundary_4 <double> analytical_function_1;
//
//     double LaplaceExactSolution = analytical_function_1.value(x);
//
...
void LaplaceGetExactSolutionGradient(const std::vector < double >& x, std::vector < double >& gradientValue) {
  double pi = acos(-1.);
...
/*
  ...
  double u = analytical_function_1.value(x);*/
...
//
//    std::vector< Unknown >  u = ml_prob.get_system <double>(current_system_number).get_unknown_list_for_assembly();
//
//
//
//   std::vector <Math::Function <double> *> exact_sol(feOrder.size());
//
