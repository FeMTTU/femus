#ifndef __femus__applications__00_tutorial__poisson_eqn__hpp__
#define __femus__applications__00_tutorial__poisson_eqn__hpp__
...
//***************** Check Number of Unknowns **********************************  
 ...
 //========= BOUNDARY - BEGIN ==================   
    if (dim == 1)   shankar::poisson_equation::natural_loop_1d/*<real_num, real_num_mov>*/(& ml_prob, msh, ml_sol,
                      iel, geom_element, xType,
                      solname_u, solFEType_u,
                      Res
                     );

    if (dim == 2 || dim == 3)   shankar::poisson_equation::natural_loop_2d3d<real_num, real_num_mov>(& ml_prob, msh, ml_sol,
                      iel, geom_element, xType,
                      solname_u, solFEType_u,
                      Res,
                      elem_all,
