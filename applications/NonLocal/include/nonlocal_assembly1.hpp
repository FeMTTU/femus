                ...
                for (unsigned jg = 0; jg < jgNumber; jg++) {
                  ...
                  for (unsigned i = 0; i < nDof1; i++) {
                    ...
                    for (unsigned j = 0; j < nDof1; j++) {
                      double jacValue1 = weight1[ig] * weight2 * 3. / 4. * (1. / pow (dist, 4.)) * (phi1x[ig][i] - phi1y) * phi1x[ig][j];
                    ...
                    for (unsigned j = 0; j < nDof2; j++) {
                      double jacValue2 = - weight1[ig] * weight2 * 3. / 4. * (1. / pow (dist, 4.)) * (phi1x[ig][i] - phi1y) * phi2y[j];
