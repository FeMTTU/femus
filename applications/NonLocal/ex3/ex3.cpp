...
// ******* Solution *******
  ...
  mlSol.GetWriter()->Write (Files::_application_output_directory, "FETI", print_vars, 0);
  ...
  mlSolGlobal.GetWriter()->Write (Files::_application_output_directory, "global", print_vars2, 0);
