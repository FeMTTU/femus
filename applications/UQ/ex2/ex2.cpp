...
int main(int argc, char** argv) {
  ...
  int numberOfEigPairs = 4; //number of eigenpairs desired

  std::vector < std::pair<double, double> > eigenvalues(numberOfEigPairs); //this is where we store the eigenvalues
