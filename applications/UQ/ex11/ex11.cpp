...
//
//   ComputeMultivariateHermitePoly(MultivariateHermitePoly, MultivariateHermiteQuadratureWeights, numberOfQuadraturePoints, pIndex, Jp, Tp);
  //END
...
//   ComputeHermitePoly(HermitePoly,  numberOfQuadraturePoints, maxPolyOrder);
