...
int main(int argc, char** args) {
  ...
  const std::string mesh_file = relative_path_to_build_directory + DEFAULT_MESH_FILES_PATH + "01_gambit/02_2d/square/minus0p5-plus0p5_minus0p5-plus0p5/square_16x16_quad.neu";
