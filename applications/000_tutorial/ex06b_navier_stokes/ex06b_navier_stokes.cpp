...
int main(int argc, char** args) {
  ...
  const std::string mesh_file = relative_path_to_build_directory + DEFAULT_MESH_FILES_PATH + "01_gambit/02_2d/rectangle/minus2p5-plus2p5_minus0p5-plus0p5/rectangle_quad.neu";
