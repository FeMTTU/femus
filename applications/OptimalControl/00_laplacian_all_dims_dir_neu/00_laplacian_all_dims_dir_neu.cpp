...
bool SetBoundaryConditionDirNeu(const std::vector < double >& x, const char name[], double& value, const int face_name, const double time) {
...
//    mesh_files.push_back("Mesh_1_z_all_dir.med");
   mesh_files.push_back("Mesh_2_xy_boundaries_groups.med");
