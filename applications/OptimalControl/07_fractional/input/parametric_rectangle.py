...
smesh.SetName(Mesh_1, 'Mesh_1')
try:
  Mesh_1.ExportMED(r'/home/gbornia/software/femus/unittests/test_mesh_read_write/input/square_parametric_rectangle.med',auto_groups=0,minor=40,overwrite=1,meshPart=None,autoDimension=0)
  pass
except:
  print('ExportMED() failed. Invalid file name?')
[ Group_1_0, Group_3_0, Group_2_0, Group_4_0, Group_12_0 ] = Mesh_1.GetGroups()
