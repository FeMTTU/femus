...
//                     Sol_n_el_dofs_quantities, //filled inside
 ...
 //****************************- END *********************** 
  ...
  //############################ fake_iel_flag - END #######################################
   ...
   //************ set fake theta flag: this flag tells me what degrees of freedom of the current element are fake for the theta variable  - BEGIN *********************
...
//========= gauss_loop boundary===============================================================
    ...
    for (unsigned ldim = 0; ldim < dim; ldim++) {
    elem_all[qrule_i][ielGeom][SolFEType_Mat[ldim + adj_pos_begin]]->shape_funcs_vol_at_bdry_current_elem(iqp_bdry, jface, JacI_qp, 
