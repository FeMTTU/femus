...
//********************* vol-at-bdry adjoint *******************
    ...
    phi_adj_vol_at_bdry.reserve(max_size);   // local test function
    vector <double> phi_adj_x_vol_at_bdry;
    phi_adj_x_vol_at_bdry.reserve(max_size * dim);  // local test function first order partial derivatives
