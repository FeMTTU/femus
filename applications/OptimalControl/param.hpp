...
namespace Multiple_controls_and_homogeneous_boundary_conditions {
...
//    else if (faceName == ctrl::GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES :: opposite_face(face_for_control)) { value =  gamma * domain_length; }
//    else                                       { value = gamma * (
...
//     const unsigned face_for_control = _face_with_extremes_index[0];
      ...
      for(unsigned f = 0; f < femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_index_size; f++) {

           if (faceName == femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_index[f]) { is_facename_a_control_face = true; break; }
           ...
           if (faceName == femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_index[f]) {

              if ( !(
                  x[ femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::tangential_direction_to_Gamma_control(faceName) ] >  femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_extremes[f][0] +  OFFSET_TO_INCLUDE_LINE  &&
                     x[ ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::tangential_direction_to_Gamma_control(faceName) ] <
                  femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_extremes[f][1] -  OFFSET_TO_INCLUDE_LINE 
                 ) ) {
                      dirichlet = true;
                 }
              }
...
//      assert( _face_with_extremes_index_size == 2 );
     ...
     const unsigned face_for_control_principal = femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_index[0];
    ...
    const double domain_length = 1.;
	  ...
	  for(unsigned f = 0; f < femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_index_size; f++) {
        ...
        if (faceName == femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_index[f]) {
              ...
              else if (faceName == ctrl::GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES :: opposite_face(face_for_control_principal)){
                     if ( !(x[ ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::tangential_direction_to_Gamma_control(faceName) ] > femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_extremes[f][0] +  OFFSET_TO_INCLUDE_LINE  &&
                            x[ ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::tangential_direction_to_Gamma_control(faceName) ] <
                     femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_extremes[f][1] -  OFFSET_TO_INCLUDE_LINE ) )   { value =  gamma * domain_length; }
                     else {value = 0.; }
              }
              else {
                     if ( !(x[ ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::tangential_direction_to_Gamma_control(faceName) ] > femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_extremes[f][0] +  OFFSET_TO_INCLUDE_LINE  &&
                            x[ ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::tangential_direction_to_Gamma_control(faceName) ] <
                     femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_extremes[f][1] -  OFFSET_TO_INCLUDE_LINE ) ) { value =
                            gamma * (
                                      ctrl::boundary_conditions::opposite_face_ctrl_or_state_value(face_for_control_principal, domain_length) + ctrl::DOMAIN_CLASS::sign_function_for_delimiting_region(face_for_control_principal) *  x[      ctrl::GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::normal_direction_to_Gamma_control(face_for_control_principal) ] ); }
                     else {value = 0.; }
              }
        }
        else if (faceName == ctrl::GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES :: opposite_face(face_for_control_principal)) { value =  gamma * domain_length; }
        else      { value = gamma * (
                                    ctrl::boundary_conditions::opposite_face_ctrl_or_state_value(face_for_control_principal, domain_length) + ctrl::DOMAIN_CLASS::sign_function_for_delimiting_region(face_for_control_principal) *  x[      ctrl::GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::normal_direction_to_Gamma_control(face_for_control_principal) ] ); }
 ...
 //    if (ml_prob->GetMLMesh()->GetDimension() != 2 )  abort();
  ...
  //   assert( _face_with_extremes_index_size == 2 );
     ...
     if (faceName == femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_index[f]) {
        ...
        if ( !(x[ ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::tangential_direction_to_Gamma_control(faceName) ] >
               femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_extremes[f][0] +  OFFSET_TO_INCLUDE_LINE  &&
               x[ ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::tangential_direction_to_Gamma_control(faceName) ] <
               femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_extremes[f][1] -  OFFSET_TO_INCLUDE_LINE ) ) {
                dirichlet = true;
           }
...
namespace Single_control_in_front_linear {
 ...
 double ctrl_or_state_set_dirichlet_fixed_values(const MultiLevelProblem * ml_prob,
    ...
    assert( femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_index_size == 1 );

    const unsigned face_for_control = femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_index[0];
    ...
    else if(faceName == ctrl::GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES :: opposite_face(face_for_control)){ value = gamma * (
             ctrl::boundary_conditions::opposite_face_ctrl_or_state_value(adjacent_face_for_control, domain_length) + ctrl::DOMAIN_CLASS::sign_function_for_delimiting_region(adjacent_face_for_control) *  x[
             ctrl::GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::normal_direction_to_Gamma_control(adjacent_face_for_control) ] );  }
    else if(faceName == ctrl::GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES :: opposite_face(adjacent_face_for_control)){ value = gamma * (
             ctrl::boundary_conditions::opposite_face_ctrl_or_state_value(face_for_control, domain_length) +
             ctrl::DOMAIN_CLASS::sign_function_for_delimiting_region(face_for_control) *  x[
             ctrl::GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::normal_direction_to_Gamma_control(face_for_control) ] );  }
 ...
 bool ctrl_or_state_set_dirichlet_flags(const MultiLevelProblem * ml_prob,
    ...
    const unsigned face_for_control = femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_index[0];
     ...
     if (faceName == face_for_control) {
        if ( !(x[ ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::tangential_direction_to_Gamma_control(faceName) ] >
            femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_extremes[0][0] +  OFFSET_TO_INCLUDE_LINE  &&
               x[ ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::tangential_direction_to_Gamma_control(faceName) ] <
            femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_extremes[0][1] -  OFFSET_TO_INCLUDE_LINE ) ) {
                dirichlet = true;
           }
    }
    else {
...
namespace Double_controls_adjacent_in_front_linear {
 ...
 double ctrl_or_state_set_dirichlet_fixed_values(const MultiLevelProblem * ml_prob,
     ...
     assert( femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_index_size == 2 );

     const unsigned face_for_control_principal = femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_index[0];
     const unsigned adjacent_face_for_control = femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_index[1];
     ...
     for(unsigned f = 0; f < femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_index_size; f++) {
        ...
        if (faceName == femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_index[f])     {  value = 0.; }
        else if(faceName == ctrl::GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES :: opposite_face(face_for_control_principal)){ value = gamma * (
             ctrl::boundary_conditions::opposite_face_ctrl_or_state_value(adjacent_face_for_control, domain_length) + ctrl::DOMAIN_CLASS::sign_function_for_delimiting_region(adjacent_face_for_control) *  x[
             ctrl::GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::normal_direction_to_Gamma_control(adjacent_face_for_control) ] );  }
        else if(faceName == ctrl::GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES :: opposite_face(adjacent_face_for_control)){ value = gamma * (
             ctrl::boundary_conditions::opposite_face_ctrl_or_state_value(face_for_control_principal, domain_length) + ctrl::DOMAIN_CLASS::sign_function_for_delimiting_region(face_for_control_principal) *  x[
             ctrl::GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::normal_direction_to_Gamma_control(face_for_control_principal) ] );  }
     }
...
namespace Triple_controls_adjacent_in_front_linear {
 ...
 double ctrl_or_state_set_dirichlet_fixed_values(const MultiLevelProblem * ml_prob,
     ...
     assert( femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_index_size == 3 );
     ...
     for(unsigned f = 0; f < femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_index_size; f++) {
         ...
         if (faceName == femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_index[f]) {
                ...
                if ( (faceName == face_for_control_principal) || (faceName == adjacent_face_for_control) )     {  value = 0.; }
                        ...
                        if ( !(x[ ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::tangential_direction_to_Gamma_control(faceName) ] > femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_extremes[f][0] +  OFFSET_TO_INCLUDE_LINE  &&
                               x[ ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::tangential_direction_to_Gamma_control(faceName) ] <
                        femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_extremes[f][1] -  OFFSET_TO_INCLUDE_LINE ) ) { value = gamma * (
                                  ctrl::boundary_conditions::opposite_face_ctrl_or_state_value(adjacent_face_for_control, domain_length) + ctrl::DOMAIN_CLASS::sign_function_for_delimiting_region(adjacent_face_for_control) *  x[
                                  ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::normal_direction_to_Gamma_control(adjacent_face_for_control) ] );  }
                        else {value = 0.; }
                }
                else if(faceName == ctrl::GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES :: opposite_face(adjacent_face_for_control)){
                        if ( !(x[ ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::tangential_direction_to_Gamma_control(faceName) ] > femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_extremes[f][0] +  OFFSET_TO_INCLUDE_LINE  &&
                               x[ ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::tangential_direction_to_Gamma_control(faceName) ] <
                        femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::_face_with_extremes_extremes[f][1] -  OFFSET_TO_INCLUDE_LINE ) ) { value = gamma * (
                               ctrl::boundary_conditions::opposite_face_ctrl_or_state_value(face_for_control_principal, domain_length) + ctrl::DOMAIN_CLASS::sign_function_for_delimiting_region(face_for_control_principal) *  x[
