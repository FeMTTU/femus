...
//namespace boundary_conditions-BEGIN
...
//
//               if ( !(x[ femus::ctrl:: GAMMA_CONTROL_LIST_OF_FACES_WITH_EXTREMES ::tangential_direction_to_Gamma_control(faceName) ] >
...
//
// }
//namespace boundary_conditions-END
