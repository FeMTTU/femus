...
Vertex_7 = geompy.MakeVertex(2, 0, 0)
Vertex_8 = geompy.MakeVertex(2, 1, 0)
...
[ Group_13_0, Group_12_0, Group_1_0 ] = Mesh_3.GetGroups()
nbAdd = Group_12_0.Add( [ 9, 10 ] )
nbAdd = Group_13_0.Add( [ 18, 17, 19, 20 ] )
Group_12_0.SetColor( SALOMEDS.Color( 1, 0.666667, 0 ))
nbAdd = Group_12_0.Add( [ 10, 9 ] )
nbAdd = Group_13_0.Add( [ 17, 18, 19, 20 ] )
Group_13_0.SetColor( SALOMEDS.Color( 1, 0.666667, 0 ))
Group_1_0.SetColor( SALOMEDS.Color( 1, 0.666667, 0 ))
smesh.SetName(Mesh_3, 'Mesh_3')
try:
  Mesh_3.ExportMED(r'/home/student/software/femus/applications/OptimalControl/boundary_control_inequality/dirichlet/dirichlet_lifting_external/input/ext_box_1.med',auto_groups=0,minor=40,overwrite=1,meshPart=None,autoDimension=0)
  pass
except:
