...
int main(int argc, char** args) {
  ...
  for(unsigned i = 0; i < maxNumberOfMeshes; i++) {
    ...
    bool elementsHaveBeenRefined = meshcoarser.FlagElementsToBeRefined(0.1, mlSol.GetSolutionLevel(numberOfUniformLevels-1)->GetSolutionByName("Error"));  //non-uniform
