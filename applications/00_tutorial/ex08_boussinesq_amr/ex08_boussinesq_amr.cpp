...
int main(int argc, char** args) {
  ...
  const std::string mesh_file = relative_path_to_build_directory + DEFAULT_MESH_FILES_PATH + "01_gambit/square/-0p5-0p5x-0p5-0p5/square_2x2_quad_Three_face_groups_Four_volume_groups_AMR.neu";
