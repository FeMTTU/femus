...
int main(int argc, char** args) {
  ...
  const std::string mesh_file = relative_path_to_build_directory + DEFAULT_MESH_FILES_PATH + "01_gambit/square_-0p5-0p5x-0p5-0p5/square_2x2_quad_Two_face_groups.neu";
