...
std::pair < double, double > GetErrorNorm(MultiLevelSolution* ml_sol, Solution* sol_from_restriction, std::vector< Unknown > & unknowns_vec); 
...
//        }
      ...
      std::pair< double , double > norm = GetErrorNorm(&ml_sol, sol, unknowns_vec);
