...
//   // ======= Mesh, coarse gen, III: from Salome - BEGIN  ========================
    const std::string mesh_file = relative_path_to_build_directory + "include/00_mesh_files/00_salome/01_non_parametric/square_2x2_centered_at_origin.med";
...
//   // ======= Mesh, coarse gen, II: from Gambit - BEGIN  ========================
    const std::string mesh_file = relative_path_to_build_directory + "include/00_mesh_files/01_gambit/square_-0p5-0p5x-0p5-0p5/square_2x2_quad.neu";
    ml_mesh.ReadCoarseMesh(mesh_file.c_str(), fe_quad_rule.c_str(), scalingFactor);
