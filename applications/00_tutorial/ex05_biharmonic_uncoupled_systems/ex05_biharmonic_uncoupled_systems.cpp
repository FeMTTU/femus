...
//   mlMsh.ReadCoarseMesh("./input/square_quad.neu","seventh",scalingFactor);
  ...
  const std::string mesh_file = relative_path_to_build_directory + DEFAULT_MESH_FILES_PATH + "00_salome/00_parametric/with_notebook/square_-0p5-0p5x-0p5-0p5_divisions_2x2.med";
