...
std::pair<double, std::vector <double> >GetKineandPointVlaue(MultiLevelSolution* mlSol);// obtain the Knetc energy evlolution;
...
int main(int argc, char** args) {
  ...
  for(unsigned time_step = 0; time_step < n_timesteps; time_step++) {
    ...
    std::pair < double, std::vector <double> > out_value = GetKineandPointVlaue(&mlSol) ;
...
std::pair <double, std::vector <double> >GetKineandPointVlaue(MultiLevelSolution* mlSol){
