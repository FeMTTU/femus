...
int main(int argc, char** args) {
  ...
  const std::string mesh_file = relative_path_to_build_directory + Files::mesh_folder_path() + "01_gambit/2d/square/minus1-plus1_minus1-plus1/square_2x2_quad_Four_boundary_groups.neu";
