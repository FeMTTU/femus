...
int main(int argc, char** args) {
  ...
  const std::string mesh_file = relative_path_to_build_directory + Files::mesh_folder_path() + "01_gambit/2d/rectangle/minus2p5-plus2p5_minus0p5-plus0p5/rectangle_quad_5x5_Three_boundary_groups.neu";
