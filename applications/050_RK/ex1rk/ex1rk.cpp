...
void AssembleAllenCahnProblem_with_Implicit_Runge_Kutta_AD (MultiLevelProblem& ml_prob);
...
int main(int argc, char** args) {
  ...
  system.SetAssembleFunction (AssembleAllenCahnProblem_with_Implicit_Runge_Kutta_AD);
...
void AssembleAllenCahnProblem_with_Implicit_Runge_Kutta_AD (MultiLevelProblem& ml_prob) {
  ...
  ImplicitRungeKuttaNonlinearImplicitSystem* mlPdeSys  = &ml_prob.get_system<ImplicitRungeKuttaNonlinearImplicitSystem> ("AllenCahn");
