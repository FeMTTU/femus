...
void ETD (MultiLevelProblem& ml_prob, const unsigned & numberOfTimeSteps)
{
  ...
  for (unsigned i =  start; i <  end; i++) {
    ...
    std::vector < double > solHSm (NLayers);  //tracer 2
    std::vector < double > solHS (NLayers);   
    std::vector < double > solHSp (NLayers);  
    std::vector < double > solHZm (NLayers);  //tracer 3
    std::vector < double > solHZ (NLayers);   
    std::vector < double > solHZp (NLayers);  
    std::vector < double > solHCm (NLayers);  //tracer 4
    std::vector < double > solHC (NLayers);   
    std::vector < double > solHCp (NLayers);  
    std::vector < double > solHDm (NLayers);  //tracer 5
    std::vector < double > solHD (NLayers);   
    std::vector < double > solHDp (NLayers);  
    std::vector < double > solHEm (NLayers);  //tracer 6
    std::vector < double > solHE (NLayers);   
    std::vector < double > solHEp (NLayers); 
    ...
    std::vector < double > aResHS (NLayers, 0.);
    std::vector < double > aResHZ (NLayers, 0.);
    std::vector < double > aResHC (NLayers, 0.);
    std::vector < double > aResHD (NLayers, 0.);
    std::vector < double > aResHE (NLayers, 0.);
    std::vector < double > aResHTLili (NLayers, 0.);
    std::vector < double > aResHSLili (NLayers, 0.);
    std::vector < double > aResHZLili (NLayers, 0.);
    std::vector < double > aResHCLili (NLayers, 0.);
    std::vector < double > aResHDLili (NLayers, 0.);
    std::vector < double > aResHELili (NLayers, 0.);
...
//std::cout << "first stage " << std::endl;
  ...
  if (twostage == true) {
    ...
    for (unsigned i =  start; i <  end; i++) {
      ...
      std::vector < double > solh (NLayers);   // local coordinates
      std::vector < double > solhp (NLayers);
      std::vector < double > solvm (NLayers);   
      std::vector < double > solvp (NLayers);   
      std::vector < double > solHTm (NLayers);  //tracer 1
      std::vector < double > solHT (NLayers);   
      std::vector < double > solHTp (NLayers);  
      std::vector < double > solHSm (NLayers);  //tracer 2
      std::vector < double > solHS (NLayers);   
      std::vector < double > solHSp (NLayers);  
      std::vector < double > solHZm (NLayers);  //tracer 3
