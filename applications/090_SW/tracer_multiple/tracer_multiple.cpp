...
void ETD (MultiLevelProblem& ml_prob, const unsigned & numberOfTimeSteps)
{
  ...
  for (unsigned i =  start; i <  end; i++) {
    ...
    std::vector < double > solHSm (NLayers);   // local coordinates
    std::vector < double > solHS (NLayers);   // local coordinates
    std::vector < double > solHSp (NLayers);   // local coordinates
    std::vector < double > solHZm (NLayers);   // local coordinates
    std::vector < double > solHZ (NLayers);   // local coordinates
    std::vector < double > solHZp (NLayers);   // local coordinates
