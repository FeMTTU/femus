...
./fsisteady -input "./input/turek.neu"  -nlevel 1 -rhof 1000 -muf 1 -rhos 1000 -E 1500000 -ni 0.5 -ic_bdc "../../../../lib64/libfsi_steady_2d_turek_hron_benchmark_bdc.so" -outer_ksp_solver "preonly" -max_outer_solver_iter 1 -nrefinement 1
...
#./fsisteady -input "./input/turek.neu"  -nlevel 1 -rhof 1000 -muf 1 -rhos 1000 -E 1500000 -ni 0.5 -ic_bdc "../../../../lib64/libfsi_steady_2d_turek_hron_benchmark_bdc.so" -outer_ksp_solver "preonly" -max_outer_solver_iter 1 -ksp_view -mat_mumps_icntl_11 1 -std_output stdOutput.txt -nrefinement 1 > stdOutput.txt

# Direct solver with ksp_view and residual evaluation
# modify -nrefinement to increase or decrease the number of refinement
# ./fsisteady -ksp_view -mat_mumps_icntl_11 1 -input "./input/turek.neu" -nrefinement 6 -nlevel 1 -rhof 1000 -muf 1 -rhos 1000 -E 1500000 -ni 0.5 -ic_bdc "../../../../lib64/libfsi_steady_2d_turek_hron_benchmark_bdc.so" -outer_ksp_solver "preonly" -max_outer_solver_iter 1
