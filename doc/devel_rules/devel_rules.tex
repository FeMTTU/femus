...
\chapter{HOW TO SHARE SUBMESHES ON CONTIGUOUS FACES}


When you explode adjacent faces, the edges are called differently... we should identify them


 \chapter{HOW TO CHANGE THE MESH BY CHANGING THE GEOMETRY}
...
\chapter{COPY MESH}
 ...
 It seems that Copy Mesh does not copy groups as well
 
 

\chapter{HOW TO MESH - 3D}
...
\chapter{QUADRILATERAL MESH of a CIRCLE/SEMISPHERE}
...
So the idea seems to be NOT the following:
 ...
 \chapter{SALOME - BOUNDARY CONDITIONS}
