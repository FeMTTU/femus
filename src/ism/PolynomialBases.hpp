...
namespace femus {
  ...
  // LINE specialized functions - BEGIN
  ...
  // LINE specialized functions - END
    
  // QUAD specialized functions - BEGIN
  ...
  // QUAD specialized functions - END

  // TRI specialized functions - BEGIN
  ...
  // TRI specialized functions - END

  // HEX specialized functions - BEGIN
  ...
  // HEX specialized functions - END

  // TET specialized functions - BEGIN
  ...
  // TET specialized functions - END

  // WEDGE specialized functions - BEGIN
  ...
  // WEDGE specialized functions - END
  
// CheckIfPointIsInsideReferenceDomain - BEGIN
...
// CheckIfPointIsInsideReferenceDomain - END
