...
static void mass_residual (std::vector < real_num > & Res,
 ...
 inline static double laplacian_row(const std::vector < unsigned > & SolFEType, 
                             const std::vector < std::vector < double > > & phi_x_fe_qp, 
 ...
 inline static double laplacian_row_col(const std::vector < unsigned > & SolFEType, 
                                 const std::vector < std::vector < double > > & phi_x_fe_qp, 
                                 const int my_row_pos, 
                                 const int my_col_pos, 
                                 const int i, 
...
template < class real_num, class real_num_mov >
 inline /*static*/ double assemble_jacobian<real_num, real_num_mov>::laplacian_row(const std::vector < unsigned > & SolFEType, 
                             const std::vector < std::vector < double > > & phi_x_fe_qp, 
                             const std::vector < std::vector < double > > & sol_grad_qp,
                             const int my_row_pos, 
                             const int my_col_pos, 
...
template < class real_num, class real_num_mov >
 inline /*static*/ double assemble_jacobian<real_num, real_num_mov>::laplacian_row_col(const std::vector < unsigned > & SolFEType, 
                                 const std::vector < std::vector < double > > & phi_x_fe_qp, 
                                 const int my_row_pos, 
                                 const int my_col_pos, 
                                 const int i, 
