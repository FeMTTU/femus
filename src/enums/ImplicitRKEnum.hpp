...
const unsigned nRK[5] = {1,2,3,3,2};
const double *cIRK[5] ={ cLEGENDRE1,  cLEGENDRE2,  cLEGENDRE3,  cNORSETT3 , cCROUZEIX2};
const double *bIRK[5] ={ bLEGENDRE1,  bLEGENDRE2,  bLEGENDRE3,  bNORSETT3 , bCROUZEIX2};
const double *aIRK[5] ={ aLEGENDRE1,  aLEGENDRE2,  aLEGENDRE3,  aNORSETT3 , aCROUZEIX2};
const double *aiIRK[5]={ aiLEGENDRE1, aiLEGENDRE2, aiLEGENDRE3, aiNORSETT3, aiCROUZEIX2};
