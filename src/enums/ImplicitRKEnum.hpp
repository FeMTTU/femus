...
// Pippo 3 points. Order of convergenge 4
const double cPIPPO3[3] =  {0.4358665215084589, 0.7179332607542295, 1};
const double bPIPPO3[3] =  {1.2084966491760099, -0.6443631706844686, 0.4358665215084589};
const double aPIPPO3[9] = {
  0.4358665215084589, 0., 0., 
  0.2820667392457705, 0.4358665215084589, 0., 
  1.2084966491760099, -0.6443631706844686, 0.4358665215084589
};
const double aiPIPPO3[9] = {
...
const double *cIRK[6] ={ cLEGENDRE1,  cLEGENDRE2,  cLEGENDRE3,  cNORSETT3 , cCROUZEIX2, cPIPPO3};
const double *bIRK[6] ={ bLEGENDRE1,  bLEGENDRE2,  bLEGENDRE3,  bNORSETT3 , bCROUZEIX2, bPIPPO3};
const double *aIRK[6] ={ aLEGENDRE1,  aLEGENDRE2,  aLEGENDRE3,  aNORSETT3 , aCROUZEIX2, aPIPPO3};
const double *aiIRK[6]={ aiLEGENDRE1, aiLEGENDRE2, aiLEGENDRE3, aiNORSETT3, aiCROUZEIX2, aiPIPPO3};
