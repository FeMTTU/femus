...
class wedge2: public basis {
  ...
  double d2tri2dx2(const double& x,const double& y, const int& j,const int& i) const;
  double d2tri2dy2(const double& x,const double& y, const int& j,const int& i) const;
  double d2tri2dxdy(const double& x,const double& y, const int& j,const int& i) const;
